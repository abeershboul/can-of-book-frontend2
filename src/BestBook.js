...
class BestBooks extends React.Component {
  ...
  componentDidMount = () => {
    axios
      ...
      .get(`https://abeerrrrr.herokuapp.com/books?email=${this.state.email}`)
  ...
  deleteBook = (id) => {
    axios
      ...
      .delete(`https://abeerrrrr.herokuapp.com/deleteBook/${id}email=${this.state.email}`) //http://localhost:3010/deleteCat?id=${id}
      .then((result) => {
        this.setState({
          books: result.data,
        });
